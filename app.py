...
WORDS_DB = {
    ...
    "자연": ["바다", "산", "강", "사막", "숲"],
    "계절": ["봄", "여름", "가을", "겨울", "장마"],
    "취미": ["독서", "그림", "등산", "게임", "춤", "노래", "요리", "베이킹", "사진찍기", "영화보기", "드라마보기", "글쓰기", "공예", "뜨개질", "자수", "종이접기", "퍼즐맞추기", "보드게임", "악기연주", "노트꾸미기",
           "자전거타기", "조깅", "낚시", "캠핑", "하이킹", "수영", "스쿠버다이빙", "스케이트", "스키", "서핑"],
    "가구": ["의자", "책상", "침대", "소파", "옷장", "식탁", "책장", "커피테이블", "서랍장", "화장대",
           "스툴", "벤치", "거울장", "옷걸이", "옷수납장", "침대협탁", "TV장", "신발장", "와인랙", "선반", "사이드테이블", "장식장", "수납박스", "파티션", "좌식테이블", "아일랜드식탁", "진열장", "행거", "붙박이장", "캐비닛"],
    "날씨": ["맑음", "비", "눈", "바람", "안개"],
    "행성": ["지구", "화성", "금성", "목성", "토성"],
